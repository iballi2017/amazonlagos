...
<div class="container">
    <div class="row">
        <div class="col">
        <div class="card my-5" style="max-width: 400px; margin: 0 auto">
            ...
            <div class="card-body">
                <form action="#">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="form_grp mb-3">
                                <label class="password_capital d-block" for="confirm_pwd">Confirm Password</label>
                ...
                <div class="my-5">
                    ...
                    <a href="./login-page.php" class="d-block text-center border_lemon py-2 txt_lemon green_hover rounded">Login</a>
                </div>
            </div>
        </div>
        </div>
